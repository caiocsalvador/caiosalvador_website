...
const experienceItems = [
  ...
  },
  {
    ...
    endDate: "2018",
    description:
      "I took time for professional development and to move to another country. During this time I develop many web-based applications and websites using different technologies like Angular, Python, Django, PHP, Laravel, Wordpress and more. For example a language exchange app where people would share their knowledge and learn from each other.",
    color: "green",
  },
  {
  ...
  },
  {
    ...
    endDate: "2015",
    description:
      "This company was incubated in the state's wind energy center, they had multiple legacy projects that had to be maintenad while developing new features. I was a Full-stack development there, using Python, Django, Ruby, Ruby on Rails. I also developed a mobile app using Phonegap",
    color: "orange",
  },
  {
